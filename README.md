...
#### Importance:
This question demonstrates the impact of a global pandemic on crime, specifically pickpocketing–which is highly driven by global tourism to Los Angeles. In tracking the pickpocketing by year, the data also represents the end of the global lockdown. It might also help the Los Angeles police department to track whether or not their pickpocketing mitigation efforts have affected the actual number of crimes either increasing or decreasing. Finally, adding an element of location to the question would allow the Los Angeles police to track which areas are most prone to the crime of pickpocketing, and therefore give them insight into where to station more officers or focus on awareness efforts.
...
I first created a density map of the pickpocketing crimes over the entire city of Los Angeles to identify the most and least dense pickpocketing areas to use in my selection. Then I created the bar chart by filtering the crime description to only include pickpocketing. I also filtered the area names by Hollywood, a highly tourist neighborhood, Central LA, a moderate tourist neighborhood, and West LA, a more residential reference group.

#### Analysis:
In analyzing the bar graph, we see that West LA–a more residential area of the city–had a very similar number of pickpocketing crimes as Hollywood during the height of the pandemic in 2020. Over the next three years, there is a skyrocket in pickpocketing across all areas, likely due to more people leaving their homes and returning to normal life. However, Hollywood and Central LA hold a much higher proportion of pickpocketing crimes, showing their influence as highly populated areas that rely more on tourism. In the year 2022, there were almost 11 times as many pickpocketing crimes in Hollywood compared to West LA. The data slightly dips in 2023, suggesting that the number of pickpockets may have leveled off to return to normal and will not keep increasing.
...
The workbook including the graphs mentioned above is attached to this repository.
